...
2. **Data Aggregation:** Execute parallel or sequential web checks to pull contextual data.
3. **Synthesis & Curation:** Format the gathered data into a structured report (analogous to a dynamic "knowledge page"), categorizing insights automatically.
4. **Output:** Return the beautifully rendered markdown report.
